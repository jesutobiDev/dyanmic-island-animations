...
const Navigation = ({ launchAnimation, launchDialPad }) => {
    ...
    return (
        <div className="bg-red w-full h-[70px] absolute bottom-[10px] flex gap-2 md:gap-2 items-center px-4 z-20 justify-around">
            ...
            <div className='bg-black rounded-[15px] h-[50px] md:h-[60px] w-[50px] md:w-[60px] flex items-center justify-center' onClick={() => launchAnimation("faceId")} se  >
